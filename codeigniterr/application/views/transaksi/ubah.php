...
<main role="main" class="container">
	...
	<h1>Table</h1>
	<!-- load header -->
	<!-- action akan dilakukan ke controller transaksi dengan fungsi ubah -->
	<!-- PS : 
	name pada input harus sama dengan table didatabase
	intinya hanya pada syntax input dan form saja lainnya dari bootstrap e -->
	<form action="<?php echo base_url('transaksi/ubah/'.$getData['id_transaksi']); ?>" method="post">
		<div class="form-group row">
			<label for="id_transaksi" class="col-sm-2 col-form-label">id_transaksi</label>
			<div class="col-sm-10">
				<input type="text" name="id_transaksi" class="form-control" id="id_transaksi"  value="<?php echo $getData['id_transaksi'] ?>" placeholder="id_transaksi">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="message" class="form-control" id="message"  value="<?php echo $getData['message'] ?>" placeholder="message">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="tgl_kirim" class="form-control" id="tgl_kirim"  value="<?php echo $getData['tgl_kirim'] ?>" placeholder="tgl_kirim">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="tgl_terima" class="form-control" id="tgl_terima"  value="<?php echo $getData['tgl_terima'] ?>" placeholder="tgl_terima">
