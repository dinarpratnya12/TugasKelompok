...
<main role="main" class="container">
	...
	<form action="<?php echo base_url('product/ubah/'.$getData['id_leptop']); ?>" method="post">
		<div class="form-group row">
			<label for="id_leptop" class="col-sm-2 col-form-label">id_leptop</label>
			<div class="col-sm-10">
				<input type="text" name="id_leptop" class="form-control" id="id_leptop"  value="<?php echo $getData['id_leptop'] ?>" placeholder="id_leptop">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="info" class="form-control" id="info"  value="<?php echo $getData['info'] ?>" placeholder="info">
		...
		div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" name="foto" class="form-control" id="foto"  value="<?php echo $getData['foto'] ?>" placeholder="foto">
